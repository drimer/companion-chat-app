...
- [ ] During an existing conversation, when the second attempt at a API call also fails, show the message written by the user as a greyed out bubble so that they can copy-paste it if they want
